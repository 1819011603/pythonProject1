...
def CARS_Cloud(X, y, N=50, f=20, cv=10):
    ...
    return OptWave
from utils import loadDataSet01,filter

# https://blog.csdn.net/qq_35667901/article/details/124796568
def CARS_():
    # global index
    x0, y0 = loadDataSet01('./PLS-master/data/train.txt', ', ')  # 单因变量与多因变量
    x0 = filter(x0)
    # lis = CARS_Cloud(x0,y0,50,20,10)
    lis = CARS_Cloud(x0,y0,50,11,10)
    print("获取的波段数",len(lis))
